...
func (r Router) AddAdvertisementRouter(rg *gin.RouterGroup) {
	...
	advertisementRouter.POST("/", middleware.JWTAuthMiddleWare(tokenmode.ACCESS_TOKEN, r.deps.redis), advertisementCont.CreateAdvertisement)
	...
	advertisementRouter.GET("/:advertisement_id", middleware.JWTAuthMiddleWare(tokenmode.ACCESS_TOKEN, r.deps.redis), advertisementCont.GetAdvertisementByID)
	...
	advertisementRouter.PUT("/:advertisement_id", middleware.JWTAuthMiddleWare(tokenmode.ACCESS_TOKEN, r.deps.redis), advertisementCont.UpdateAdvertisement)
