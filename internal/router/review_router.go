...
func (r Router) AddReviewRouter(rg *gin.RouterGroup) {
	...
	reviewRouter.GET("/:review_id", middleware.JWTAuthMiddleWare(tokenmode.ACCESS_TOKEN), reviewCont.GetReviewByID)
	...
	reviewRouter.PUT("/:review_id", middleware.JWTAuthMiddleWare(tokenmode.ACCESS_TOKEN), reviewCont.UpdateReview)
